...
1.  **Data Storage - Crypto Tokens List:**
    ...
    ![List of Crypto Tokens in Database](assets/list_of_crypto_tokens_in_database.jpg)
...
2.  **Automated Price Fetching & Update:**
    ...
    ![Overview of Automations - Fetch Crypto and Share Prices](assets/overview_of_automations.jpg)
    ![Script of Fetching API and Updating Current Price](assets/script_of_fetching_api_and_updating_current_price.jpg)
...
3.  **Notification Triggering:**
    ...
    ![Triggers to Send Notification and Updating Records](assets/triggers_to_send_notification_and_updating_records.jpg)
...
4.  **Multi-Channel Alerts:**
    ...
    * **Email:** A detailed email notification is sent to the specified recipient, showing the token, current price, and limits.
        ![Snapshot of Email Notification](assets/snapshot_of_email_notification.png)
    * **Slack:** An alternative automation is configured to send a message to a designated Slack channel.
        ![Alternative Notification - Sending via Slack App](assets/alternative_notification_sending_thru_slack_app.jpg)
